...
class ScannerPrompt:
    init_plan_prompt: str = """You are a Vulnerability Scanning Assistant running on Kali Linux 2026. 
    ...
    init_reasoning_prompt: str = """You are a Vulnerability Scanning Assistant running on Kali Linux 2026. 
    Your role is to assist testers in the cybersecurity training process.
